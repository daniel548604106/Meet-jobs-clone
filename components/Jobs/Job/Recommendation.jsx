...
const Recommendation = () => {
  return (
    <div className="relative text-center bg-gradient-to-bl from-blue-dark to-blue-light rounded w-full px-2 py-5 ">
      ...
      <button className="py-2 px-5 rounded text-blue-dark bg-white font-semibold">分享職缺</button>
    </div>
  );
};
